...
def guide_rows() -> list[dict[str, str]]:
    return [
        ...
        },
        {
            "section": "版本差異",
            "item": "完整版",
            "description": "完整版有 7 個分頁與 63 個股票欄位，包含「過舊低信心」分頁，以及開高低價、成交筆數、目標價修正家數、月營收金額與月增率、財報金額、基本面整體備註等明細。",
        },
        {
            "section": "版本差異",
            "item": "_lite 輕量版",
            "description": "輕量版有 6 個分頁與 43 個股票欄位，不另放「過舊低信心」分頁；保留收盤與成交摘要、主要目標價、估值、月營收年增率、EPS、三種利潤率、各組來源/備註與整體狀態，適合日常快速開啟。",
        },
        {
            "section": "版本差異",
            "item": "資料是否相同",
            "description": "完整版與輕量版來自同一次抓取，股票列、資料來源與計算邏輯相同；輕量版只是少放明細欄位與一個彙整分頁，不是較舊或較少抓資料的版本。",
        },
        {
            "section": "閱讀順序",
            "item": "建議先看",
